...
const prefixCommand = require("../../Prefix/06-AuthorizedCommands/SetSuspiciousTime.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("süre")
                .setDescription("Şüpheliye atılması için gereken süre")
                .setRequired(true)
            ),
        en: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("time")
                .setDescription("Time required to be sent to suspicious")
                .setRequired(true)
            )
    },
