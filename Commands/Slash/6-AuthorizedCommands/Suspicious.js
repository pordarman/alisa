...
const prefixCommand = require("../../Prefix/06-AuthorizedCommands/Suspicious.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addUserOption(option => option
                .setName("üye")
                .setDescription("Şüpheliye atılacak üye")
                .setRequired(true)
            ),
        en: new SlashCommandBuilder()
            ...
            .addUserOption(option => option
                .setName("member")
                .setDescription("Member to be thrown to suspicious")
                .setRequired(true)
            )
    },
