...
const prefixCommand = require("../../Prefix/06-AuthorizedCommands/SetVoiceChannel.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addChannelOption(option => option
                .setName("kanal")
                .setDescription("Botun giriş yapacağı ses kanalı")
                .setRequired(true)
            ),
        en: new SlashCommandBuilder()
            ...
            .addChannelOption(option => option
                .setName("channel")
                .setDescription("Voice channel that the bot will join")
                .setRequired(true)
            )
    },
