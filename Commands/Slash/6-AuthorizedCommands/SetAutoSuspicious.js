...
const prefixCommand = require("../../Prefix/06-AuthorizedCommands/SetAutoSuspicious.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("ayar")
                .setDescription("Otomatik şüpheliye atma ayarını açmak mı yoksa kapatmak mı istersiniz?")
                .setRequired(true)
                .addChoices(
                    {
                        name: "Aç",
        ...
        en: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("setting")
                .setDescription("Do you want to turn on or off the auto suspicious setting?")
                .setRequired(true)
                .addChoices(
                    {
                        name: "On",
