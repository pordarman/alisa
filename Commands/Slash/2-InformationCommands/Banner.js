...
const prefixCommand = require("../../Prefix/02-InformationCommands/Banner.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addUserOption(option => option
                .setName("kullanıcı")
                .setDescription("Bannerini göstermek istediğiniz kullanıcı")
                .setRequired(false)
            ),
        en: new SlashCommandBuilder()
            ...
            .addUserOption(option => option
                .setName("user")
                .setDescription("The user whose banner you want to show")
                .setRequired(false)
            )
    },
