...
const prefixCommand = require("../../Prefix/02-InformationCommands/MemberNames.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addUserOption(option => option
                .setName("kullanıcı")
                .setDescription("İsimleri gösterilecek kullanıcı")
                .setRequired(true)
            ),
        en: new SlashCommandBuilder()
            ...
            .addUserOption(option => option
                .setName("user")
                .setDescription("User whose names will be shown")
                .setRequired(true)
            )
    },
