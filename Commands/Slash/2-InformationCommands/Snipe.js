...
const prefixCommand = require("../../Prefix/02-InformationCommands/Snipe.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addUserOption(option => option
                .setName("kullanıcı")
                .setDescription("Silinen son mesajını görmek istediğiniz kullanıcı")
                .setRequired(false)
            ),
        en: new SlashCommandBuilder()
            ...
            .addUserOption(option => option
                .setName("user")
                .setDescription("The user whose last message you want to see")
                .setRequired(false)
            )
    },
