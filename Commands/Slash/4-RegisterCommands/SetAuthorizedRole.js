...
const prefixCommand = require("../../Prefix/04-RegisterCommands/SetAuthorizedRole.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addRoleOption(option => option
                .setName("rol")
                .setDescription("Kayıt yetkilisi rolü")
                .setRequired(true)
            ),
        en: new SlashCommandBuilder()
            ...
            .addRoleOption(option => option
                .setName("role")
                .setDescription("Authorized role for registration")
                .setRequired(true)
            )
    },
