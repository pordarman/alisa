...
const prefixCommand = require("../../Prefix/04-RegisterCommands/SetRecordSetting.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("ayar")
                .setDescription("Kayıt ayarını açmak mı kapatmak mı istersiniz? (eğer kapatırsanız kayıt yapamazsınız)")
                .setRequired(true)
                .addChoices(
                    {
                        name: "Aç",
        ...
        en: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("setting")
                .setDescription("Do you want to turn on or off the record setting? (if you turn off, you can't register)")
                .setRequired(true)
                .addChoices(
                    {
                        name: "On",
