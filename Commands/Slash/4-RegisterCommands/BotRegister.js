...
const prefixCommand = require("../../Prefix/04-RegisterCommands/BotRegister.js");
...
module.exports = {
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addUserOption(option => option
                .setName("bot")
                .setDescription("Kayıt edilecek bot")
                .setRequired(true)
            )
            .addStringOption(option => option
                .setName("isim")
                .setDescription("Botun ismi")
                .setRequired(false)
            ),
        en: new SlashCommandBuilder()
            ...
            .addUserOption(option => option
                .setName("bot")
                .setDescription("Bot to register")
                .setRequired(true)
            )
            .addStringOption(option => option
                .setName("name")
    ...
    async execute(params) {
        ...
        switch (params.language) {
            case "tr":
                member = params.int.options.getMember("bot");
