...
const prefixCommand = require("../../Prefix/04-RegisterCommands/SetNameRequired.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("ayar")
                .setDescription("İsim zorunluluğunu açmak mı yoksa kapatmak mı istersiniz?")
                .setRequired(true)
                .addChoices(
                    {
                        name: "Aç",
        ...
        en: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("setting")
                .setDescription("Do you want to turn on or off the name requirement?")
                .setRequired(true)
                .addChoices(
                    {
                        name: "On",
