...
const prefixCommand = require("../../Prefix/04-RegisterCommands/SetAuthroizedNotification.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("ayar")
                .setDescription("Yetkili etiketlemeyi açmak mı yoksa kapatmak mı istersiniz?")
                .setRequired(true)
                .addChoices(
                    {
                        name: "Aç",
        ...
        en: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("setting")
                .setDescription("Do you want to turn on or off the authorized notification?")
                .setRequired(true)
                .addChoices(
                    {
                        name: "On",
