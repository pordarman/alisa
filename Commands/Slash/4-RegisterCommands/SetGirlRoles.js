...
const prefixCommand = require("../../Prefix/04-RegisterCommands/SetGirlRoles.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("roller")
                .setDescription("Kız rollerini ayarlamak için etiketleyin veya sıfırlamak için **sıfırla** yazın")
                .setRequired(true)
            ),
        en: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("roles")
                .setDescription("Tag the roles to set the girl roles or type **reset** to reset")
                .setRequired(true)
            )
    },
