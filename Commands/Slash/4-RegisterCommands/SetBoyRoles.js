...
const prefixCommand = require("../../Prefix/04-RegisterCommands/SetBoyRoles.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("roller")
                .setDescription("Erkek rollerini ayarlamak için etiketleyin veya sıfırlamak için **sıfırla** yazın")
                .setRequired(true)
            ),
        en: new SlashCommandBuilder()
            ...
            .addStringOption(option => option
                .setName("roles")
                .setDescription("Tag the roles to set the boy roles or type **reset** to reset")
                .setRequired(true)
            )
    },
