...
const prefixCommand = require("../../Prefix/04-RegisterCommands/SetRegisterLogChannel.js");
    ...
    data: { // Komutun verileri
        tr: new SlashCommandBuilder()
            ...
            .addChannelOption(option => option
                .setName("kanal")
                .setDescription("Kayıt loglarının yapılacağı kanal")
                .setRequired(true)
            ),
        en: new SlashCommandBuilder()
            ...
            .addChannelOption(option => option
                .setName("channel")
                .setDescription("Channel where registration logs will be made")
                .setRequired(true)
            )
    },
