...
module.exports = {
    ...
    description: { // Komutun açıklaması
        tr: "Belirtilen kişiye belirtilen rolü verir",
        en: "Gives the specified role to the specified person"
    },
    ...
    usage: { // Komutun kullanım şekli
        tr: "<px>rolver <@kişi veya Kişi ID'si> <@roller veya Rollerin ID'si>",
        en: "<px>giverole <@user or User ID> <@roles or Role IDs>"
    },
    ...
    async execute({
        ...
        // Eğer kendine rol verilmek isteniyorsa hata döndür
        ...
        // Kişide olan rolleri diziden çıkar ve yeni diziye ekle
        ...
        // Eğer kişinin rolleri yoksa hata döndür
        if (newRoles.length == 0) return errorEmbed(messages.noRoleToGive);
