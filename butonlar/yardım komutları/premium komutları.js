        ...
        try {
            ...
            let [array, baslik] = int.client.allCommands(sunucudb, "p")
                , düğmesağ = new ButtonBuilder()
                    ...
                    .setCustomId("yardım_komutlar_sağok" + int.user.id + "p")
                    .setDisabled(true)
                ...
                , düğmesol = new ButtonBuilder()
                    ...
                    .setCustomId("yardım_komutlar_solok" + int.user.id + "p")
                    .setDisabled(true)
                , düğmesaghizli = new ButtonBuilder()
                    .setStyle(1)
                    .setEmoji(ayarlar.emoji.sagokhizli)
                    .setCustomId("yardım_komutlar_saghizli" + int.user.id + "p")
                    .setDisabled(true)
                , düğmesolhizli = new ButtonBuilder()
                    .setStyle(1)
                    .setEmoji(ayarlar.emoji.solokhizli)
                    .setCustomId("yardım_komutlar_solhizli" + int.user.id + "p")
                    .setDisabled(true)
