...
module.exports = {
    ...
    async run({ int, guildDatabase, alisa, hata, guildId, guild }) {
        try {
            ...
            let [array, baslik] = int.client.allCommands(guildDatabase, "b")
                , düğmesağ = new ButtonBuilder()
                    .setStyle(1)
                    .setEmoji(ayarlar.emoji.sagok)
                    .setCustomId("yardım_komutlar_sağok" + int.user.id + "b")
                ...
                , düğmesol = new ButtonBuilder()
                    ...
                    .setCustomId("yardım_komutlar_solok" + int.user.id + "b")
                    .setDisabled(true)
                , düğmesaghizli = new ButtonBuilder()
                    .setStyle(1)
                    .setEmoji(ayarlar.emoji.sagokhizli)
                    .setCustomId("yardım_komutlar_saghizli" + int.user + "b")
                , düğmesolhizli = new ButtonBuilder()
                    .setStyle(1)
                    .setEmoji(ayarlar.emoji.solokhizli)
                    .setCustomId("yardım_komutlar_solhizli" + int.user + "b")
                    .setDisabled(true)
