...
module.exports = {
    ...
    async run({ int, guildDatabase, alisa, hata, guildId, guild }) {
        try {
            ...
            let [array, baslik] = int.client.allCommands(guildDatabase, "k")
                , düğmesağ = new ButtonBuilder()
                    .setStyle(1)
                    .setEmoji(ayarlar.emoji.sagok)
                    .setCustomId("yardım_komutlar_sağok" + int.user.id + "k")
                ...
                , düğmesol = new ButtonBuilder()
                    ...
                    .setCustomId("yardım_komutlar_solok" + int.user.id + "k")
                    .setDisabled(true)
                , düğmesaghizli = new ButtonBuilder()
                    .setStyle(1)
                    .setEmoji(ayarlar.emoji.sagokhizli)
                    .setCustomId("yardım_komutlar_saghizli" + int.user.id + "k")
                , düğmesolhizli = new ButtonBuilder()
                    .setStyle(1)
                    .setEmoji(ayarlar.emoji.solokhizli)
                    .setCustomId("yardım_komutlar_solhizli" + int.user.id + "k")
                    .setDisabled(true)
