...
module.exports = {
    ...
    async run({ int, guildDatabase, alisa, hata, guildId, guild }) {
        try {
            ...
            let [array, baslik] = int.client.allCommands(guildDatabase, "j")
                , düğmesağ = new ButtonBuilder()
                    .setStyle(1)
                    .setEmoji(ayarlar.emoji.sagok)
                    .setCustomId("yardım_komutlar_sağok" + int.user.id + "j")
                ...
                , düğmesol = new ButtonBuilder()
                    ...
                    .setCustomId("yardım_komutlar_solok" + int.user.id + "j")
                    .setDisabled(true)
                , düğmesaghizli = new ButtonBuilder()
                    .setStyle(1)
                    .setEmoji(ayarlar.emoji.sagokhizli)
                    .setCustomId("yardım_komutlar_saghizli" + int.user.id + "j")
                , düğmesolhizli = new ButtonBuilder()
                    .setStyle(1)
                    .setEmoji(ayarlar.emoji.solokhizli)
                    .setCustomId("yardım_komutlar_solhizli" + int.user.id + "j")
                    .setDisabled(true)
