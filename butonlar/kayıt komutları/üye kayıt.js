...
module.exports = {
    ...
    async run({ int, guildDatabase, alisa, hata, sonradan, guildId, guild }) {
        try {
            ...
            int.message.reply({ content: `${ayarlar.emoji.uye} <@${sahipid}>, kayıt etmek istediğiniz <@${memberid}> adlı kişinin sadece ismini ${guildDatabase.kayıt.yaszorunlu ? "ve yaşını" : ""} mesaj olarak yazınız` }).then(async ms => {
