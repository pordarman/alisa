...
module.exports = {
    ...
    async run({ int, sunucudb, alisa, hata, sonradan, sunucuid, guild }) {
        try {
            ...
            let erkekrolseysi = sunucudb.kayıt.erkek || []
            ...
            int.message.reply({ content: `${ayarlar.emoji.kiz} <@${sahipid}>, kayıt etmek istediğiniz <@${memberid}> adlı kişinin sadece ismini ${sunucudb.kayıt.yaszorunlu ? "ve yaşını" : ""} mesaj olarak yazınız` }).then(async ms => {
