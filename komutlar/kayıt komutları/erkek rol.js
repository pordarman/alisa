...
module.exports = {
  ...
  async run({ guildDatabase, pre, alisa, msg, args, guildId, prefix, hata, guild, msgMember, guildMe }) {
    try {
      ...
      if (guildDatabase.kayıt.secenek) return hata('Kayıt etme seçeneğiniz __**Normal Kayıt**__ olarak ayarlı\n\n• Eğer kız ve erkek olarak kaydetmek isterseniz **' + prefix + 'seç cinsiyet** yazabilirsiniz')
      if (args[0] === "sıfırla") {
        if (!guildDatabase.kayıt.erkek) return hata('Erkeklere verilecek olan rol zaten sıfırlanmış durumda')
      ...
      let kayıtsızrolid = guildDatabase.kayıt
      ...
      let yetkilirolid = guildDatabase.kayıt
      ...
      guildDatabase.kayıt.erkek = rolmap
