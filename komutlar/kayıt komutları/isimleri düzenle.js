    ...
    async run({ guildDatabase, pre, alisa, msg, args, guildId, prefix, hata, guild, msgMember, guildMe }) {
        try {
            ...
            if (args[0] == "kayıt") {
                ...
                guildDatabase.kayıt.isimler.kayıt = girilenKomut
                ...
                const girilenKomut = args.slice(1).join(" ")
                guildDatabase.kayıt.isimler.giris = girilenKomut
                let tag = guildDatabase.kayıt.tag || " "
                msg.reply({ content: `Sunucuya yeni kullanıcı geldikten sonra düzenlenecek isim başarıyla ayarlandı! Bu isim düzenleme işlemi botları etkilemez!!\n\n• ‼️ **Uyarı!** Bu isim düzenleme sadece __**kayıt kanalı**__ ayarlı olduğu zaman düzenlenecektir${guildDatabase.kayıt.kanal ? "" : `• Kayıt kanalını ayarlamak için **${prefix}kanal #kanal** yazabilirsiniz`}\n\n**Şöyle gözükecek**` }).catch(err => { })
