...
module.exports = {
    ...
    description: "Sunucunun veya kullanıcının son kayıtlarını gösterir", // Komutun açıklaması
    category: "Bilgi komutları", // Komutun kategorisi (yardım menüsü için)
    usage: "<px>sonkayıtlar [@kişi veya Kişi ID'si]", // Komutun kullanım şekli
    ...
    async execute({
        ...
        if (!length) return errorEmbed(
            user ?
                "Etiketlediğiniz kişi daha önceden hiç kayıt yapmadığı için tablo gösterilemiyor" :
                "Bu sunucuda daha önce hiç kayıt yapılmadığı için tablo gösterilemiyor"
        );
        ...
        function createEmbed(pageNum) {
            ...
            return new EmbedBuilder()
                ...
                .setDescription(
                    `**• ${embedDescription} __${LENGTH_TO_HUMANIZE}__ tane kayıt bulundu\n\n` +
