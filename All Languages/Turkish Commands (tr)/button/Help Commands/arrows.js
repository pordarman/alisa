...
module.exports = {
    ...
    async execute({
        ...
        if (!messageEmbed) return errorEmbed(`Mesajda gösterilen embed silindiği için artık bu butonlar işe yaramaz. Lütfen **${guildDatabase.prefix}yardım** yazarak yeni bir mesaj daha oluşturunuz`);
        ...
        const editEmbed = new EmbedBuilder(messageEmbed)
            ...
            .setFooter({
                text: `Sayfa ${toPageIndex + 1}/${MAX_PAGE_NUMBER}`
            });
