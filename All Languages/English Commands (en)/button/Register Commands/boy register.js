...
module.exports = {
    ...
    async execute({
                                ...
                                .addFields(
                                    ...
                                    },
                                    {
                                        ...
                                        value: `> 👤 **Name:** <@${memberId}>\n` +
                                            ...
                                            `> ${EMOJIS.role} **Given role(s):** ${boyRolesString}`,
                                        inline: true
                                    }
                                )
                            ...
                            if (afterRegisterChannelId) {
                                ...
                                if (channel) {
                                    ...
                                    // Eğer özel mesaj ayarlanmamışsa mesajı gönder
                                        ...
                                        const embed = new EmbedBuilder()
                                            .setTitle(`Welcome aboard ${recreateMemberName} ${EMOJIS.hi}`)
                                            .setDescription(`${EMOJIS.crazy} **• <@${memberId}> joined us with the roles ${boyRolesString}**`)
                                            .addFields(
                                                {
                                                    name: "Registration information",
                                                    value: `**• Registered person:** ${recreateMemberName}\n` +
                                ...
                                if (logChannel) {
                                    ...
                                    const embed = new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            ...
                                            `**• Given role(s):** ${boyRolesString}\n` +
                                            `**• New name:** ${recreateName}\n` +
                                            `**• Registration type:** Boy ${EMOJIS.boy}\n` +
        ...
        int.client.buttonRegisterMember.set(`${guildId}.${memberId}`, authorId);
        int.message.reply(
            `${EMOJIS.boy} <@${authorId}>, Please write **only the name${guildDatabase.register.isAgeRequired ? " and age" : ""}** of the person <@${memberId}> you want to register as a message`,
        )
