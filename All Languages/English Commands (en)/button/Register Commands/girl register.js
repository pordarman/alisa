...
module.exports = {
    name: "registerGirl", // Butonun ismi
    cooldown: 3, // Butonun bekleme süresi
    description: "Kullanıcıyı kız olarak kayıt eder", // Butonun açıklaması
    ...
    async execute({
        ...
        if (registerDatas) {
            ...
            return registerMember({
                ...
                authorId,
                girlRoleIds: guildDatabase.register.roleIds.girl,
        ...
        int.client.buttonRegisterMember.set(`${guildId}.${memberId}`, authorId);
        int.message.reply(
            `${EMOJIS.girl} <@${authorId}>, Please write **only the name${guildDatabase.register.isAgeRequired ? " and age" : ""}** of the person <@${memberId}> you want to register as a message`,
        )
